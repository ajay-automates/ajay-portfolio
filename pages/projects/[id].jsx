...
import { FiClock, FiTag, FiGithub, FiLinkedin } from 'react-icons/fi';
								...
								(info) => {
									return (
										...
										>
											...
											<a
												href={info.title === 'Website' || info.title === 'GitHub' ? info.details : '#'}
												className={
													info.title === 'Website' ||
													info.title === 'GitHub' ||
													info.title === 'Phone'
												...
												aria-label={info.title === 'Website' || info.title === 'GitHub' ? 'Project Link' : 'Project Info'}
												target={info.title === 'Website' || info.title === 'GitHub' ? '_blank' : undefined}
												rel={info.title === 'Website' || info.title === 'GitHub' ? 'noopener noreferrer' : undefined}
											>
												{info.details}
											</a>
										</li>
					...
					<div>
						...
						<div className="flex items-center gap-3 mt-5">
							{props.project.ProjectInfo.SocialSharing.map(
								(social, index) => {
									const IconComponent = social.icon === 'github' ? FiGithub : FiLinkedin;
									return (
										<a
											key={index}
											href={social.url}
											...
											aria-label={`${social.name} - ${props.project.title}`}
											className="bg-ternary-light dark:bg-ternary-dark text-gray-400 hover:text-indigo-500 dark:hover:text-indigo-400 p-2 rounded-lg shadow-sm duration-500"
										>
